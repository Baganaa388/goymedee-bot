...
├ 🖼  Зураг              → зураг илгээх
│  ├ ✨ Чанар сайжруулах
│  ├ 📐 Хэмжээ тохируулах → 4:5 · 1:1 · 16:9 · 9:16
│  │                       → ✂️ Тайрах | 🖼 Бүтнээр (бүдэг дэвсгэр)
│  └ 🎨 Branding нэмэх    → гарчиг → classic · overlay · split · sidebar · бүгд
├ ✍️  Текст              → текст илгээх
│  ├ 🔤 Үг үсгийн алдаа
│  └ 📝 Найруулга        → 📰 Мэдээний хэв · ✂️ Товчлох · 📖 Дэлгэрүүлэх
├ 🔗 Нийтлэл хуулах      → линк илгээх
├ 🌐 Сайт руу нийтлэх    → 🚧 хөгжүүлэлтэд
└ ⚙️ Тохиргоо
```

Командууд: `/menu` · `/cancel` · `/help`

Нэг зураг илгээгээд гурван үйлдлийг дараалан хийж болно — зураг сессэд
хадгалагдана. Гарчиг сольсны дараа ч ижил зураг дээр загвар солих боломжтой.

Нийтлэл хуулсны дараа түүний текстийг шууд үг үсэг шалгах эсвэл найруулга
засах руу оруулж болно.
